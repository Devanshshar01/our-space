...
ALTER TABLE "oauth_refresh_token" ADD CONSTRAINT "oauth_refresh_token_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;
--> statement-breakpoint
...
(
	...
	'Canvas',
	ARRAY[
		'https://widget-woad-nine.vercel.app/api/auth/callback',
...
(
	...
	'Notes',
	ARRAY[
		'https://notes-rust-five.vercel.app/api/auth/callback',
